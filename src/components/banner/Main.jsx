...
const Main = () => {
  ...
  return (
    ...
    <div className={styles.topic}>
      <h1 className={styles.topper}>Why eXStore?</h1>
      <p className={styles.subb}>We are the leading source to download Musics,Games,Movies and 4K Images</p>
      {/* Cards */}
      <div class="card">
        <div class="item item--1">
          ...
          <span class="text text--1"> Games </span>
        </div>
        <div class="item item--2">
          ...
          <span class="text text--2"> Music </span>
        </div>
        <div class="item item--3">
          ...
          <span class="text text--3"> Pictures </span>
        </div>
        <div class="item item--4">
          ...
          <span class="text text--4"> Movies </span>
        </div>
      </div>
